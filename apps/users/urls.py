...
urlpatterns = [
    ...
    path("user/me/<int:id>/", views.UserProfileRetrieveUpdateDestroyAPIView.as_view(), name='my_profile'),
    path("user/profile/<int:id>/", views.UserProfileRetrieveAPIView.as_view(), name='user_profile'),
    ...
    path("companies/detail/<int:id>/", views.CompanyRetrieveAPIView.as_view(), name='company_detail'),
    path("companies/my-company/<int:id>/", views.CompanyRetrieveUpdateDestroyAPIView.as_view(), name='my_company_detail'),
    path("job-seeker/create/", views.UserProfileCreateAPIView.as_view(), name='user_profile_create'),
    path("job-seeker/<int:id>/upload-resume/", views.ResumeUploadingAPIView.as_view(), name='resume_upload'),
